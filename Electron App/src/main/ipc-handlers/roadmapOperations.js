  ...
  ipcMain.handle("delete-topic",async (event,{new_roadmap,tid,dir})=>{
    ...
    try{
      ...
      const confirmation = await dialog.showMessageBoxSync(null,{
        ...
        defaultId:0,
        title:'Delete Topic',
        message:'Do you really want to delete this topic? All the topic resources will also be deleted.'
      })
  ...
  ipcMain.handle("delete-module",async (event,{roadmap,index,dir})=>{
    ...
    try
    {
      const res = await dialog.showMessageBoxSync(null,{
        ...
        defaultId:0,
        title:'Delete Module',
        message:'Do you really want to delete this module? All module resources will also be deleted.'
      })
