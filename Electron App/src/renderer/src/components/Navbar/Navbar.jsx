...
export default function Navbar()
{
    ...
    return(<>
        ...
        <div style={{zIndex:2,backgroundColor:'var(--primaryColor)',display:'flex',justifyContent:'space-between',alignItems:'center',padding:'40px 20px',margin:'0px',borderBottom:'1px solid var(--border)'}}>
            ...
            <div style={{display:'flex',alignItems:'center',justifyContent:'center',gap:'20px'}}>
                ...
                <h3 style={{color:'var(--text)',fontSize:'18px',fontWeight:'600'}}>Home</h3>
            </div>
