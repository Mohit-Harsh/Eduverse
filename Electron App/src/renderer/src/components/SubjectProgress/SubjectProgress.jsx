        ...
        >
          <div>
            <span
              ...
              style={{ margin: 0, fontWeight: '700', color: 'var(--black)' }}
            >
              UNIT {unit}
            </span>
            <span className={styles.span} style={{ margin: '0 0 0 5px', color: 'grey' }}>
              {subject}
            </span>
          </div>
          <div>
            <span className={styles.span} style={{ color: 'var(--black)' }}>
              {progress}%
            </span>
          </div>
        </div>
