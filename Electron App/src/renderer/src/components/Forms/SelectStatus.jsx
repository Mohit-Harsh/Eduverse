      ...
      >
        <div
          style={{
            ...
            overflow: 'hidden',
            borderRadius: '10px',
            backgroundColor: 'var(--sidebarButtonBackground)'
          }}
        >
          <p
          ...
          <div id={`options${index}`} className={styles.options} style={{ maxHeight: '0px' }}>
            <p
              onClick={() =>
                handleChange(`options${index}`, module, difficulty, topic, 'not-started')
              }
              style={{
                color: statusColor['not-started'],
                display: status == 'not-started' ? 'none' : 'block'
              }}
            >
              not-started
            </p>
            <p
              onClick={() =>
                handleChange(`options${index}`, module, difficulty, topic, 'in-progress')
              }
              style={{
                color: statusColor['in-progress'],
                display: status == 'in-progress' ? 'none' : 'block'
              }}
            >
              in-progress
            </p>
            <p
              onClick={() =>
                handleChange(`options${index}`, module, difficulty, topic, 'completed')
              }
              style={{
