...
export default function DropFileInput({file,setFile})
{
    ...
    return (
        <>
            {file==undefined?<div ref={wrapperRef} className={styles.drop_file_input} onDragEnter={onDragEnter} onDragLeave={onDragLeave} onDrop={onDrop}>
            ...
            </div>:<div className={styles.file}>

                <p>{file.name}</p>
                <button onClick={removeFile}><svg className={styles.remove} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
