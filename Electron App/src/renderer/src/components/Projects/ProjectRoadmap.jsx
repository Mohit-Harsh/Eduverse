...
export default function ProjectRoadmap() {
  ...
  function topicAdd(module, difficulty, dir) {
    let new_roadmap = [...roadmap]
    new_roadmap[module].Topics[difficulty].push({
      tid: v1(),
      title: 'New Topic',
      status: 'not-started'
    })
    const res = window.api.addTopic({ new_roadmap, dir })
    if (res) setRoadmap(new_roadmap)
  }

  async function removeTopic(module, difficulty, topic, dir) {
    let new_roadmap = [...roadmap]
    const tid = new_roadmap[module].Topics[difficulty][topic].tid
    new_roadmap[module].Topics[difficulty] = new_roadmap[module].Topics[difficulty]
      .slice(0, topic)
      .concat(new_roadmap[module].Topics[difficulty].slice(topic + 1))
        ...
        <div className={styles.container}>
          ...
          <div className={styles.roadmap}>
              ...
              <div>
                ...
                <ThemeProvider theme={theme}>
                  <Tooltip title="Save" placement="top" arrow>
                    <button onClick={updateRoadmap} className={styles.savebtn}>
                      <svg
                        aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                ...
                <button
                  ...
                  onClick={() => {
                    document.getElementById('moduleForm').style.setProperty('display', 'flex')
                  }}
                >
                  <svg
                    aria-hidden="true"
            ...
            {roadmap.length > 0 ? (
                ...
                <div key={key} className={styles.module}>
                  <div className={styles.header}>
                    <div className={styles.header_col1}>
                      ...
                      >
                        <button className={styles.dropbtn} onClick={() => handleDrop(key)}>
                          <svg
                    ...
                    <div className={styles.moduleControl}>
                      ...
                      <ThemeProvider theme={theme}>
                        <Tooltip title="Resources" placement="top" arrow>
                          <Link
                            style={{ display: 'flex', textAlign: 'center' }}
                            to={`/resources/${item.Module}`}
                            state={{ roadmap: item, dir: state.dir, id: item.mid }}
                          >
                            <svg
                      ...
                      <ThemeProvider theme={theme}>
                        <Tooltip title="Delete" placement="top" arrow>
                          <button onClick={() => deleteModule(key, state.dir)}>
                            <svg
                              aria-hidden="true"
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 24 24"
                  ...
                  <div id={`body${key}`} className={styles.body} style={{ maxHeight: '0px' }}>
                    <div className={styles.easy}>
                      ...
                      <div className={styles.topicDiv}>
                        {item.Topics.Easy.length > 0 ? (
                          item.Topics.Easy.map((topic, k) => (
                            <div className={styles.topic} key={k}>
                              <hr style={{ display: k == 0 ? 'none' : 'block' }} />

                              <div>
                                <ThemeProvider theme={theme}>
                                  <Tooltip title={topic.title} placement="top-start">
                                    <input
                                      onChange={(event) => handleTopicChange(event, key, 'Easy', k)}
                                      id={`module${key + 1}easy${k + 1}`}
                                ...
                                <div>
                                  <SelectStatus
                                    ...
                                    topic={k}
                                    status={topic.status}
                                    index={`module${key}_easy_topic${k}`}
                                  />
                                  <ThemeProvider theme={theme}>
                                    <Tooltip title="Resources" placement="top" arrow>
                                      <Link
                                        style={{ display: 'flex', textAlign: 'center' }}
                                        to={`/resources/${topic.title}`}
                                        state={{ roadmap: item, dir: state.dir, id: topic.tid }}
                                      >
                                        <svg
                                          className={styles.resource}
                                          aria-hidden="true"
                                  ...
                                  <button onClick={() => removeTopic(key, 'Easy', k, state.dir)}>
                                    <svg
                                      aria-hidden="true"
                                      xmlns="http://www.w3.org/2000/svg"
                                      width="24"
                      ...
                      <div className={styles.addTopic}>
                        <button
                          onClick={() => topicAdd(key, 'Easy', state.dir)}
                    ...
                    <div className={styles.medium}>
                      <span>Medium</span>
                      <div className={styles.topicDiv}>
                        {item.Topics.Medium.length > 0 ? (
                          item.Topics.Medium.map((topic, k) => (
                            <div className={styles.topic} key={k}>
                              <hr style={{ display: k == 0 ? 'none' : 'block' }} />
                              <div>
                                <ThemeProvider theme={theme}>
                                  <Tooltip title={topic.title} placement="top-start">
                                    <input
                                      onChange={(event) =>
                                        handleTopicChange(event, key, 'Medium', k)
                                      }
                                      id={`module${key + 1}medium${k + 1}`}
                                      defaultValue={topic.title}
                                    />
                                  </Tooltip>
                                </ThemeProvider>
                                <div>
                                  <SelectStatus
                                    ...
                                    topic={k}
                                    status={topic.status}
                                    index={`module${key}_medium_topic${k}`}
                                  />
                                  <ThemeProvider theme={theme}>
                                    <Tooltip title="Resources" placement="top" arrow>
                                      <Link
                                  ...
                                  <button onClick={() => removeTopic(key, 'Medium', k)}>
                                    <svg
                                      aria-hidden="true"
                                      xmlns="http://www.w3.org/2000/svg"
                                      width="24"
                          ...
                          <p>No Medium Topics</p>
                        )}
                      </div>

                      <div className={styles.addTopic}>
                        <button
                          onClick={() => topicAdd(key, 'Medium', state.dir)}
                          className={styles.addbtn}
                        >
                          <svg
                            className="w-6 h-6 text-gray-800 dark:text-white"
                    ...
                    <div className={styles.hard}>
                      <span>Hard</span>
                      <div className={styles.topicDiv}>
                        {item.Topics.Hard.length > 0 ? (
                          item.Topics.Hard.map((topic, k) => (
                            <div className={styles.topic} key={k}>
                              <hr style={{ display: k == 0 ? 'none' : 'block' }} />
                              <div>
                                <ThemeProvider theme={theme}>
                                  <Tooltip title={topic.title} placement="top-start">
                                    <input
                                      onChange={(event) => handleTopicChange(event, key, 'Hard', k)}
                                      id={`module${key + 1}hard${k + 1}`}
                                      defaultValue={topic.title}
                                    />
                                  </Tooltip>
                                </ThemeProvider>
                                <div>
                                  <SelectStatus
                                    ...
                                    topic={k}
                                    status={topic.status}
                                    index={`module${key}_hard_topic${k}`}
                                  />
                                  <ThemeProvider theme={theme}>
                                    <Tooltip title="Resources" placement="top" arrow>
                                      <Link
                                  ...
                                  <button onClick={() => removeTopic(key, 'Hard', k)}>
                                    <svg
                                      aria-hidden="true"
                                      xmlns="http://www.w3.org/2000/svg"
                                      width="24"
                      ...
                      <div className={styles.addTopic}>
                        <button
                          onClick={() => topicAdd(key, 'Hard', state.dir)}
                          className={styles.addbtn}
                        >
                          <svg
                            className="w-6 h-6 text-gray-800 dark:text-white"
              ...
              <NoFiles
                title={'No Existing Modules'}
                msg={'Click on New Module button to create a module.'}
              />
            )}
          </div>
        </div>
