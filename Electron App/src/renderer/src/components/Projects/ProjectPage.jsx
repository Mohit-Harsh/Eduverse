...
export default function ProjectPage({ projects, setProjects }) {
  ...
  async function handleDelete(date, index) {
    ...
    new_projects[date] = new_projects[date]
      .slice(0, index)
      .concat(new_projects[date].slice(index + 1))
    ...
    if (res == true) setProjects(new_projects)
  }
        ...
        <div className={styles.container}>
          ...
          <div className={styles.maindiv}>
            <div className={styles.header}>
              ...
              <button className={styles.new} onClick={handleClick}>
                <svg
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
            ...
            <div className={styles.body}>
              {Object.keys(projects).length > 0 ? (
                    ...
                    {projects[item].map((project, k) => (
                      <div key={k} className={styles.card}>
                        ...
                        <div className={styles.col2}>
                          <ThemeProvider theme={theme}>
                            <Tooltip arrow title="Resources" placement="top">
                          ...
                          <ThemeProvider theme={theme}>
                            <Tooltip arrow title="Topics" placement="top">
                              <span style={{ cursor: 'pointer' }}>
                                <svg
                                  aria-hidden="true"
                                  xmlns="http://www.w3.org/2000/svg"
                          ...
                          <p style={{ backgroundColor: status[project.status] }}>
                            {project.status}
                          </p>
                          <Link
                            to={`${project.title}`}
                            state={{ course: project.title, dir: project.dirPath }}
                          >
                ...
                <NoFiles
                  ...
                  msg={'Click on New Project button to create a project.'}
                />
              )}
            </div>
          </div>
